...
int main() {
	...
	Mat A12 = final_RANSAC(max_inlier_ransac_dst, max_inlier_ransac_src, max_inlier_ransac_src.size());
	Mat A21 = final_RANSAC(max_inlier_ransac_src, max_inlier_ransac_dst, max_inlier_ransac_src.size());
