...
int main() {
	...
	output = gaussianfilter(input, 3, 1, 1, "adjustkernel"); //Boundary process: zero-paddle, mirroring, adjustkernel

	namedWindow("Gaussian Filter: adjustkernel", WINDOW_AUTOSIZE);
	imshow("Gaussian Filter: adjustkernel", output);
