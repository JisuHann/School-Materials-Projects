...
int main() {
	...
	// Read each image
	I1 = imread("C:\\Img01.jpg");
	I2 = imread("C:\\Img02.jpg");
	...
	std::cout << I_f.cols << std::endl;
	std::cout << I_f.rows << std::endl;
...
Mat cal_affine(int ptl_x[], int ptl_y[], int ptr_x[], int ptr_y[], int number_of_points) {
   ...
   std::cout << "This is AffineM" << std::endl;
